		...
		<div class="col-lg-8">
			...
			<div class="card mb-4">
				<a href="#"><img class="card-img-top"
					<%-- src="<spring:url value='/image/${detail.fileName}'/>" style="object-fit:scale-down; width:800px; height:700px; " alt="${list.kind}" title="${list.kind}"/></a> --%>
					src="<spring:url value='/image/${detail.fileName}'/>" style="background-image object-fit:scale-down;"  alt="${list.kind}" title="${list.kind}"/></a>
				<div class="card-body">
				...
				<div class="card-header"><!-- 강아지 특징 --><c:out value="${detail.name }"/> 특징</div>
					...
					<a class="btn btn-warning" href="#!">사진 더보기-></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&emsp;&nbsp;&emsp;&nbsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;&emsp;
					<button type="submit" class="btn btn-outline-danger">삭제합니다</button>&nbsp;
					<button type="button" class="btn btn-outline-primary" onclick="location.href='/doglist2'">목록으로</button>
					<!-- <p></p>
					<p style="text-align:center;">
					<button type="submit" class="btn btn-outline-danger">삭제합니다</button>&nbsp;&emsp;
					<button type="button" class="btn btn-outline-primary" onclick="location.href='/doglist2'">목록으로</button>
					</p> -->
				</div>
			</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8">
			...
			<!-- 사진더보기로 옮기 여기는 주석처리<button type="submit" class="btn btn-warning">삭제합니다</button> -->
			<!-- 삭제처리를 위해  form 태그의 method 속성을 POST지정하고 submit 버튼 클릭시 Controller 에서 처리된다. -->
			
			
			
			<!-- 사진더보기로 옮기 여기는 주석처리<button type="button" class="btn btn-success" onclick="location.href='/doglist2'">목록으로</button> -->
